...
export interface ShieldSettings { masterEnabled:boolean; firewallMode:FirewallMode; tempProtection:TemporaryProtectionMode; tempProtectionExpiresAt?:number; scamShieldEnabled:boolean; smartCallScreeningEnabled:boolean; aiScreeningEnabled?:boolean; autoCancelSpamCalls:boolean; cancelDelaySeconds:number; blockUnknownNumbers:boolean; blockPrivateHidden:boolean; blockInternational:boolean; blockShortcodes:boolean; aggressiveSmsFilter:boolean; aiAnalysisEnabled:boolean; dropCallInstantly:boolean; playRingtone:boolean; autoSyncDatabase:boolean; lastSyncedTimestamp:number; sensitivity:SensitivityLevel; communityDatabaseVersion:string; neighborSpoofEnabled?:boolean; pingBackShieldEnabled?:boolean; userPhoneNumber?:string; privateCallPrefix?:string; }
