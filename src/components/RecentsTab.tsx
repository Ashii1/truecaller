...
export default function RecentsTab({ calls, lookupProfile, onInitiateCall, onSelectCall, onBlockNumber, onDeleteCall, onClearAllCalls }: RecentsTabProps) {
  ...
  // Do not call an optional native WebView method from React here. Android already
  // enriches device CallLog entries with ContactsContract.PhoneLookup before they
  // reach this screen. Keeping Recents independent of that bridge prevents a
  // missing/older WebView interface from crashing the entire UI.
